...
import type { UserAccount, ResetUserPasswordPayload } from "./types";
...
export default function ResetPasswordModal({
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    const payload: ResetUserPasswordPayload = { new_password: password };
    ...
    >
      <div className={styles.modal}>
        ...
        <p className={styles.subtitle}>
          Set a new password for <strong>{user.username}</strong>. They'll
